...
const works = [
    {
        href: "https://pepemovies.netlify.app/",
        src: "./img/moviesAppImg.png",
        alt: "Pantalla de inicio de Movies App",
        title: "Movies App React",
        github: "https://github.com/pepeojose/moviesApp",
    },
    {
...
const paintWorks = (works) => {
    works.forEach((work) => {
        ...
        work.github !== ""
            ? (clone.querySelector(
                  ".page__name"
              ).innerHTML = `<a class="page__link" href="${work.github}" target="_blanck"><i class="fab fa-github contact__icon"></i></a> ${work.title}`)
